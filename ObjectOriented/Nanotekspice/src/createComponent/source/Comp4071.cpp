...
nts::Tristate nts::Comp4071::compute(size_t pin)
{
    ...
    switch (pin) {
        ...
        case 2:
            ...
            break;
        case 3:
            setState(pin, nts::Gates::Or(compute(1), compute(2)));
            break;
        case 4:
            setState(pin, nts::Gates::Or(compute(5), compute(6)));
            break;
        case 5:
            setState(pin, link->component.compute(link->pin));
            break;
        ...
        case 9:
            ...
            break;
        case 10:
            setState(pin, nts::Gates::Or(compute(8), compute(9)));
            break;
        case 11:
            setState(pin, nts::Gates::Or(compute(12), compute(13)));
            break;
        case 12:
            setState(pin, link->component.compute(link->pin));
            break;
...
void nts::Comp4071::setLink(size_t pin, nts::IComponent &other, size_t otherPin)
{
...
void nts::Comp4071::simulate(size_t tick)
{
