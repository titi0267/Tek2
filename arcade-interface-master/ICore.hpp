...
public:
    ...
    // implementers: Use clock_nanosleep
    ...
    // // implementers: std::deque is probably the best way you can implement the texture store (which you need to be able to reload them), as pointers to elements of an std::vector do not stay stable when increasing the size of the vector
    class Texture;
